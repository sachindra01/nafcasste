    ...
    return showDialog<String>(
      ...
      builder: (BuildContext context) {
        return StatefulBuilder(builder: (context, setState){
          return Dialog(
            insetPadding: EdgeInsets.fromLTRB(20.0.w,50.0.h,20.0.w,330.h),
                     ...
                     child: SizedBox(
                      height: 300.h,
                        child: ListView.builder(
                          shrinkWrap: true,
                          itemCount:_folderController.folderlist.length,
                          padding: EdgeInsets.fromLTRB(15.0.w,15.0.h,10.0.w,15.0.h),
                          itemBuilder: (context,index){
                            return listTile(
                              ...
                              _folderController.folderlist[index].name,
                              context,
                              (){
                                // setStateBtm(() {
